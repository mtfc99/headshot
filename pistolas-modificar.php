                    ...
                    <div class="ibox-content product-box">
                        <div class="frontcard">
                            ...
                            <div class="product-desc">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                      <a href="pistolas-formulario.php?id=<?php echo $pistola->idpistola; ?>"><button class="btn btn-primary rounded-pill"><i class="fas fa-edit"></i> Modificar</button></a>  
                                    </div>
                                </div>
                            </div>
                        </div>
