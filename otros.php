                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a target="_blank" href="https://api.whatsapp.com/send?phone=+5491138950670&text=Hola Headshot 3D! Quisiera más información <?php echo " sobre " . $otro->nombre; ?>"><button class="btn btn-success rounded-pill" type="button">¡Comunicate!</button></a>
