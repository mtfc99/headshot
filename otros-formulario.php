...
include 'entidades/otro-entidad.php';
session_start();

$title = 'Ingresar otros';

$otro = new Otro();
$otro->cargarFormulario($_REQUEST);
...
<form enctype=“multipart/form-data” method="POST">
    <div class="row mt-5">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="txtNombre" id="txtNombre" value="<?php echo $otro->nombre ?>">
        </div>

        <div class=" col-md-6">
            <label for="txtPrecio">Precio del artículo</label>
            <input type="text" class="form-control" name="txtPrecio" id="txtPrecio" value="<?php echo $otro->precio ?>">
        </div>
